...
namespace BranchEval.Controllers
{
    ...
    public class UserController : ApiController
    {
        ...
        //If the user calls "api/user" without the actual username, they will receive this message back (this should also be the default page when you run the code)
        [HttpGet]
        public string Get()
        {
        ...
        {
            //If the API call has already been made, no need to make it again
